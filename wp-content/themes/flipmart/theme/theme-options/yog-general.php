...
$skin_sec_options = array();
foreach( $skins as $k => $skin ) {
    $skin_sec_options[$k] = '<span class="skin-item" style="background:' . yog_helper()->yog_validate_setting( $skin['seccolor'], 'colorpicker', 'skin_color', array() ) . ';"><span>' . $skin['name'] . '</span></span><a href="#" data-name="' . $k . '" class="skin-remove-item button-red">'. esc_html__( 'Delete Skin', 'flipmart' ) .'</a>';
}
