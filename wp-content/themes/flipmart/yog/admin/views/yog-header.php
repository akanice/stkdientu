...
<header class="yog-dashboard-header">
	...
	<ul class="yog-inline-nav yog-clearlist clearfix yog-nav-tabs">
        ...
        <li class="yog-left"><a href="<?php echo esc_url( yog_helper()->yog_dashboard_page_url() ); ?>#yog-changelog"><?php echo esc_html__( 'Changelog', 'flipmart' ) ?></a></li>
        ...
        <li class="yog-right"><a href="<?php echo esc_url( yog_helper()->yog_online_documentation_url() ); ?>" target="_blank"><i class="color fa fa-file-text-o"></i> <?php echo esc_html__( 'Documentation', 'flipmart' ) ?> <i class="fa fa-angle-right"></i></a></li>
	</ul>
