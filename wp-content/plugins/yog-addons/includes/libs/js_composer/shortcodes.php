...
--------------------------------------------------------------------------------*/
	...
	function yog_client_logos($atts, $content = null ){
        ...
        if( $yog_client_logos ):
            ...
            ?>
            <div id="brands-carousel" class="logo-slider" <?php yog_helper()->attr( false, array( 'data-animation' => $yog_animation, 'data-animation-daley' => $yog_delay ) ); ?>>
                                ...
                                <div class="caption bg-color vertical-center text-left">
                                  <?php 
                                    ...
                                    if( isset( $yog_item['yog_heading'] ) && !empty( $yog_item['yog_heading'] ) ){
                                        echo '<div class="slider-header fadeInDown-1">'. esc_html( $yog_item['yog_heading'] ) .'</div>';
                                    }
