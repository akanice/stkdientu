...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Product', 'flipmart' ); ?></th>
				<th class="product-quantity"><?php _e( 'Qty', 'flipmart' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'flipmart' ); ?></th>
			</tr>
		</thead>
		<tbody>
