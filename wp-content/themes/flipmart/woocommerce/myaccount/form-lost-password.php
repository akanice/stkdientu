...
<div class="sign-in-page sign-in-pages">
    <div class="register-form sign-in">
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
        	...
        	<h4><?php echo apply_filters( 'woocommerce_lost_password_message', __( 'Lost your password? Please enter your username or email address. You will receive a link to create a new password via email.', 'flipmart' ) ); ?></h4>
