                        ...
                        <div class="item">
                          <div class="products-">
                            <div class="hot-deal-wrapper">
                              ...
                              <?php 
                                if( $yog_product_discount = yog_helper()->get_option( 'product-hot-discount', 'raw', false, 'post' ) ){
                                    printf( '<div class="sale-offer-tag"><span>%s<br />%s</span></div>', $yog_product_discount .'%', esc_html__( 'off', 'flipmart' ) );
                                }
                                
                                //Date
                                $yog_product_date = yog_helper()->get_option( 'product-hot-time', 'raw', false, 'post' );
                                if( !empty( $yog_product_date ) ):
                              ?>
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('yog_limit') ); ?>">
                <strong><?php echo esc_html__('Number Of Products', 'flipmart') ?>:</strong>
