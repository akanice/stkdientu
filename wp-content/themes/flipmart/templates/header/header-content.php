            ...
            ?>
                ...
                <div class="cnt-block">
                  <ul class="list-unstyled list-inline">
                    <?php 
                        //Currecy
                        echo '<li>'. do_shortcode("[woocs width='70px']") .'</li>';
                    ?>   
                  </ul>
                </div>
            <?php } ?>
              ...
              <?php if( yog_helper()->get_option( 'header-search-area', 'raw', false, 'options' ) ){ ?> 
                    <div class="search-area">
                        <form method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
                    	    <input name="s" class="search-field" placeholder="<?php echo esc_attr( yog_get_translation( 'tr-blog-search' ) ); ?>" />
    ...
    <div class="container">
      <div class="yamm navbar navbar-default" role="navigation">
             <?php 
                ...
                //Get Post Meta Value.
                $yog_page_menu = yog_helper()->get_option(  'flipmart_page_menu', 'url', false, 'post' );
