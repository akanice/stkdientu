                ...
                <tr>
					<td>
						<div class="form-group form-row form-row-wide" id="calc_shipping_country_field">
                            ...
                            <select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state form-control unicase-form-control selectpicker" rel="calc_shipping_state">
                        ...
                        <div class="form-row form-row-wide form-group" id="calc_shipping_state_field">
                			...
                			<?php
                				...
                				// Dropdown Input
                					...
                					?><span>
                						<select name="calc_shipping_state" id="calc_shipping_state" class="form-control unicase-form-control" placeholder="<?php esc_attr_e( 'State / County', 'flipmart' ); ?>">
                				...
                				// Standard Input
                					...
                					?><input type="text" class="form-control unicase-form-control text-input" value="<?php echo esc_attr( $current_r ); ?>" placeholder="<?php esc_attr_e( 'State / County', 'flipmart' ); ?>" name="calc_shipping_state" id="calc_shipping_state" /><?php
