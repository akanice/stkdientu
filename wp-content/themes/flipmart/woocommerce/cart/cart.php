            				...
            				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
            					...
            					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
            						...
            						<td class="cart-product-name-info" data-title="<?php esc_attr_e( 'Product', 'flipmart' ); ?>">
                                        ...
                                        <?php 
                                            // Meta data
            								echo '<div class="cart-product-info">' . WC()->cart->get_item_data( $cart_item ) .'</div>';
                                            
                                            // Backorder notification
            								if ( $_product->backorders_require_notification() && $_product->is_on_backorder( $cart_item['quantity'] ) ) {
            									echo '<p class="backorder_notification">' . esc_html__( 'Available on backorder', 'flipmart' ) . '</p>';
            								}
                                        ?>
            						</td>
            				...
            				<td colspan="6" class="actions">
                                <div class="shopping-cart-btn">
        							<span class="">
                                        ...
                                        <input type="submit" class="btn btn-upper btn-primary pull-right outer-right-xs" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'flipmart' ); ?>" />
        							</span>
