...
<div class="track-order-page">
    ...
    <form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="track_order register-form outer-top-xs">
    	...
    	<div class="form-row form-row-first form-group">
            ...
            <input class="form-control unicase-form-control text-input" type="text" name="orderid" id="orderid" placeholder="<?php esc_attr_e( 'Found in your order confirmation email.', 'flipmart' ); ?>" />
        </div>
    	<div class="form-row form-row-last form-group">
            <label for="order_email" class="info-title"><?php _e( 'Billing email', 'flipmart' ); ?></label> 
            <input class="form-control unicase-form-control text-input" type="text" name="order_email" id="order_email" placeholder="<?php esc_attr_e( 'Email you used during checkout.', 'flipmart' ); ?>" />
        </div>
    	<div class="clear"></div>
